...
export const generateImpactAssessment = async (
  ...
  const prompt = getPromptForAssessmentType(projectDetails);
  ...
  try {
    ...
    return "An error occurred while generating the assessment. Please check your API key and network connection. The Gemini API may be temporarily unavailable.";
  }
};