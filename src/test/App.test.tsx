...
vi.mock('../App', async () => {
  ...
  type Page = 'assessment' | 'chat' | 'locker' | 'carbon' | 'market' | 'governance';
  ...
  function App() {
    ...
    const renderPage = () => {
      switch (activePage) {
        ...
        case 'carbon':
          return React.createElement('div', { 'data-testid': 'carbon-page' }, 'Carbon Page');
        case 'market':
          return React.createElement('div', { 'data-testid': 'market-page' }, 'Market Page');
        case 'governance':
          return React.createElement('div', { 'data-testid': 'governance-page' }, 'Governance Page');
        default:
          return React.createElement('div', { 'data-testid': 'assessment-page' }, 'Assessment Page');
      }
    };
    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement('nav', null,
          ...
          React.createElement('button', { onClick: () => setActivePage('carbon') }, 'Carbon Dashboard'),
          React.createElement('button', { onClick: () => setActivePage('market') }, 'Carbon Market'),
          React.createElement('button', { onClick: () => setActivePage('governance') }, 'Governance'),
