...
// NOTE: All components are now defined at the top level of the module, not inside another component.
// This ensures they have a stable identity between renders and fixes the React #299 error.
